...
public class ShorthandDeclaration extends Declaration {
	...
	protected void addMissingValues() {
		...
		case "border-color":
			...
			addIndividualDeclaration(prefix + "-top" + postfix, val1);
			addIndividualDeclaration(prefix + "-right" + postfix, val2);
			addIndividualDeclaration(prefix + "-bottom" + postfix, val3);
			addIndividualDeclaration(prefix + "-left" + postfix, val4);
		...
		case "column-rule":
			...
			addIndividualDeclaration(property + "-style", valueStyle);
			addIndividualDeclaration(property + "-color", valueColor);
			addIndividualDeclaration(property + "-width", valueWidth);
		...
		case "columns":
			...
			addIndividualDeclaration("column-width", colWidth);
			addIndividualDeclaration("column-count", colCount);
		...
		case "list-style":
			...
			addIndividualDeclaration("list-style-type", listType);
			addIndividualDeclaration("list-style-position", listPosition);
			addIndividualDeclaration("list-style-image", listImage);
		...
		case "transition":
			...
			for (int currentValueIndex = 0; currentValueIndex < allValues.size(); currentValueIndex++) {
				...
				if (currentValue.getType() == ValueType.SEPARATOR && ",".equals(currentValue.getValue())) {
					...
					addIndividualDeclaration("transition-duration", transitionDuration);
					addIndividualDeclaration("transition-timing-function", transitionTimingFunction);
					addIndividualDeclaration("transition-delay", transitionDelay);
					addIndividualDeclaration("transition-property", transitionProperty);				
		...
		case "font":
			...
			addIndividualDeclaration("font-style", fontStyle);
			addIndividualDeclaration("font-variant", fontVarient);
			addIndividualDeclaration("font-weight", fontWeight);
			addIndividualDeclaration("font-stretch", fontStretch);
			addIndividualDeclaration("font-size", fontSize);
			addIndividualDeclaration("line-height", lineHeight);
			for (DeclarationValue fontFamily : fontFamilies)
				addIndividualDeclaration("font-family", fontFamily);
		...
		case "background":
			...
			for (int currentValueIndex = 0; currentValueIndex < allValues.size(); currentValueIndex++) {
				...
				if (currentValue.getType() == ValueType.SEPARATOR) {
					...
					addIndividualDeclaration("background-image", bgImage);
					addIndividualDeclaration("background-repeat", bgRepeat);
					addIndividualDeclaration("background-attachement", bgAttachement);
					addIndividualDeclaration("background-origin", bgOrigin);
					addIndividualDeclaration("background-clip", bgClip);
					addIndividualDeclaration("background-position", bgPositionX, bgPositionY);
					addIndividualDeclaration("background-size", bgSizeH, bgSizeW);
					if (isLastLayer)
						addIndividualDeclaration("background-color", bgColor);
