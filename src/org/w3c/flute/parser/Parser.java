    ...
    try {
      ...
      while (true) {
        ...
        jj_consume_token(S);
         ...
         start = true;
         ((SelectorListImpl)l).setLocator(getLocator());
 ...
 */
 ...
 LexicalUnit params = null;
    ...
    jj_consume_token(LPARAN);
        if (operator != ' ') {
            {if (true);}// throw new CSSParseException("invalid operator before a function (" + getLocator().getLineNumber() + ", " + getLocator().getColumnNumber() + ")",
                        //                getLocator());}
        }
        String f = convertIdent(n.image);
